...
import { ChevronLeft, ChevronRight, DollarSign, Layers, ShoppingCart, Heart } from 'lucide-react'
...
export const ProductDetails = ({ className, id }: ProductDetailsProps) => {
  ...
  return (
    <div
      className={cn(
        'bg-background text-foreground flex flex-col flex-1 overflow-auto no-scrollbar',
        className,
      )}
    >
      {/* Product Header */}
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="space-y-6">
          ...
          {/* Specs */}
          <div className="rounded-lg bg-card p-4 my-6">
